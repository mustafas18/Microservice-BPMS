...
namespace FormMakerApi.Apis
{
    public static class FormTemplateApi
    {
        ...
        public static async Task<FormTemplate> CreateFormTemplate([AsParameters] FormTemplateApiService services, FormTemplate formTemplate)
        {
            return await services.Repository.AddAsync(formTemplate);
        }
        public static async Task<FormTemplate> UpdateFormTemplate([AsParameters] FormTemplateApiService services, FormTemplate formTemplate)
        {
